...
const ENTITIES = {
  clientes: {
    ...
    columns: [
      ...
      { id: 'plan', label: 'Plan' },
      { id: 'tipoEntrega', label: 'Tipo de Entrega' },
      { id: 'diasRestantes', label: 'Días Restantes' },
      { id: 'fecha_inicio', label: 'Fecha Inicio' },
      { id: 'fechaVencimiento', label: 'Vencimiento' },
      { id: 'direccion', label: 'Dir. Principal' },
      { id: 'barrio', label: 'Barrio Principal' },
      { id: 'zona_dir1', label: 'Zona Principal' },
      { id: 'dias_dir1', label: 'Días Principal' },
      { id: 'direccion2', label: 'Dir. Secundaria' },
      { id: 'barrio2', label: 'Barrio Secundario' },
      { id: 'zona_dir2', label: 'Zona Secundaria' },
      { id: 'dias_dir2', label: 'Días Secundaria' },
      { id: 'necesita_cocas', label: 'Requiere Cocas' },
