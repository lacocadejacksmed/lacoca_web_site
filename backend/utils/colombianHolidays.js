...
const getHolidaysInRange = (startYear, endYear) => {
    let allHolidays = [];
    for (let year = startYear; year <= endYear; year++) {
      allHolidays = allHolidays.concat(getColombianHolidays(year));
    }
    return allHolidays;
  };
  
module.exports = { getHolidaysInRange, getColombianHolidays };
